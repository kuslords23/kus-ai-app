...
export function JyinxStudio({ onExit }: JyinxStudioProps) {
  ...
  const commitToGitHub = async () => {
    ...
    } catch (cause) { setCommitState("error"); }
  };
