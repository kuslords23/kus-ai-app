...
const PROVIDERS: ProviderOption[] = [
  ...
  },
  {
    ...
    modelList: [
      ...
      { id: "deepseek/deepseek-v4-flash:free", label: "DeepSeek V4 Flash (Free)", hint: "1M ctx · via OpenRouter", freeTier: true },
      ...
      { id: "deepseek/deepseek-v4-flash", label: "DeepSeek V4 Flash", hint: "Fast · 1M ctx", byok: true },
      { id: "deepseek/deepseek-v4-pro", label: "DeepSeek V4 Pro", hint: "Flagship · 1M ctx", byok: true },
      { id: "openai/gpt-5", label: "GPT-5", hint: "OpenAI flagship", byok: true },
      { id: "openai/gpt-5.6-sol", label: "GPT-5.6 Sol", hint: "Flagship reasoning", byok: true },
      { id: "openai/gpt-5.6-luna", label: "GPT-5.6 Luna", hint: "Fast · cost-efficient", byok: true },
      { id: "anthropic/claude-opus-5", label: "Claude Opus 5", hint: "Anthropic flagship", byok: true },
      { id: "anthropic/claude-fable-5", label: "Claude Fable 5", hint: "Highest capability", byok: true },
      { id: "anthropic/claude-sonnet-5", label: "Claude Sonnet 5", hint: "Balanced speed & intelligence", byok: true },
      { id: "x-ai/grok-4.5", label: "Grok 4.5", hint: "xAI frontier", byok: true },
      { id: "google/gemini-3.5-flash", label: "Gemini 3.5 Flash", hint: "Google next-gen", byok: true },
